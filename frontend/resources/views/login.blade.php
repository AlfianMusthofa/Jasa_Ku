...
@section('container')
    <div class="bg-[#E9F1FA] w-[100%] h-[100vh] flex justify-center items-center">
        <div class="bg-white p-[16px] shadow-md rounded-tl-[7px] rounded-br-[7px] w-[370px] flex flex-col">
            ...
            <div class="flex flex-col gap-[8px] my-4">
            ...
            <button type="submit"
                class="text-[13px] border py-[9px] my-4 font-semibold bg-[#00ABE4] text-white rounded-tl-[7px] rounded-br-[7px]">Sign
                In</button>
            ...
            <p class="text-[11px] mt-5 text-center">Dont have an account ? <a href="#" class="font-semibold">Sign
                    Up</a>
            </p>
        </div>
    </div>
